...
// <!-- Get Packages  -->
$countrySql = "SELECT DISTINCT country FROM `package` WHERE country IN('Australia',
'Newzealand',
'Fiji'
)";
...
<section class="cont-banner mb-5">
    <div class="banner-box">
        <h2 class="main-heading">PACIFIC REGION</h2>
                ...
                <div class="col-md-6 col-lg-3 p-3">
                    <a href="package.php?country=<?php echo $row['country'] ?>">
                        <div class="cnt-card as">
                            <img class="country-img" alt="country" title="country" src="asset/images/country/<?php echo $row['country'] ?>.webp"> <div
                                class="card-name">

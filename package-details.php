  ...
  <body>
    ...
    <div class="pd-banner-sec">
      ...
      <div class="pd-header container">
        <div class="row">
          <div class="col-md-3">
            <div class="pd-title-box">
              <h2 class="sub-heading"><?php echo $package['name']; ?></h2>
              <p class="para">
                <span class="fa fa-location-dot"></span> &nbsp; <?php echo $package['country'];?>
              </p>
            </div>
          </div>
            ...
            <div class="pd-head-cont">
                ...
                <div class="row top-1">
                        ...
                        <div class="col-8 in-tit">
                            ...
                            <p class="in-title"><?php echo $package['tdays'] ;?> Days</p>
                        </div>
                    </div>
                ...
                <?php if($package['visa'] === 1){ ?>
                    <div class="row top-1">
                        ...
                        <div class="col-8 in-tit">
                            <p class="para">Visa</p>
                            <p class="in-title"><?php echo $package['visa_title'] ;?></p>
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php if($package['passport'] === 1){ ?>
                    <div class="row top-1">
                        ...
                        <div class="col-8 in-tit">
                            ...
                            <p class="in-title"><?php echo $package['passport_title'] ;?></p>
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php if($package['ticket'] === 1){ ?>
                    <div class="row top-1">
                        ...
                        <div class="col-8 in-tit">
                            ...
                            <p class="in-title"><?php echo $package['ticket_title'] ;?></p>
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php if($package['transport'] === 1){ ?>
                    <div class="row top-1">
                        ...
                        <div class="col-8 in-tit">
                            ...
                            <p class="in-title"><?php echo $package['transport_title'] ;?></p>
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php if($package['hotel'] === 1){ ?>
                    <div class="row top-1">
                        ...
                        <div class="col-8 in-tit">
                            ...
                            <p class="in-title"><?php echo $package['hotel_title'] ;?></p>
                        </div>
                    </div>
                <?php } ?>
        ...
        <br>
        <h5 class="text-center"><b> <?php echo $package['quote'] ?> </b></h5>
      </div>
    </div>
          ...
          <div class="col-lg-8">
            <div class="detail-box">
              ...
              <div class="highlights">
                  ...
                  <p><?php echo $package['highlights'];?></p>
              </div>
              <p class="para">
              ...
              <!--Days Render -->
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#<?php echo 'id'.$d['id'];?>" aria-expanded="true" aria-controls="collapseOne">
                      <h5><?php echo $d['name'];?> : <?php echo $d['title'];?></h5><br>
                    </button>
                  </h2>
                  <div id="id<?php echo $d['id'];?>" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p><?php echo $d['content'];?></p><br>
                    </div>
                  </div>
                </div>
            <?php } ?>
            ...
            <br>
            <p class="para">
              Today, you'll have the day to explore the city at your own pace.
              Your guide will provide recommendations for activities and sights
              to see.
            </p>
            <hr />
          </div>
            ...
            <div class="price-box position-sticky">
              ...
              <div class="form-box" >
                ...
                <form action="../enq_mail.php" method="post" id="myform">
                  ...
                  <input name="sd" placeholder="Date Start" class="textbox-n" type="text" onfocus="(this.type='date')" id="date" />
                  <input name="ed" placeholder="Date End" class="textbox-n" type="text" onfocus="(this.type='date')" id="date" />

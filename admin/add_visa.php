        ...
        <form action="add_visa_post.php" method="post">
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <input type="text" name="document" class="form-control" placeholder="Document" required>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <input type="text" name="embassy" class="form-control" placeholder="Embassy" required>
                </div>
            </div>
